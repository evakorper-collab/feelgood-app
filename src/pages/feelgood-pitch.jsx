...
const timeline = [
  ...
  { date: "May 11", label: "InnCubator pitch", done: false, highlight: true },
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#080808", fontFamily: "Georgia, serif", color: "#fff", display: "flex", flexDirection: "column" }}>
      <header style={{ padding: "1rem 2rem", borderBottom: "1px solid #111", display: "flex", alignItems: "center", justifyContent: "space-between", flexShrink: 0 }}>
        <span style={{ fontSize: "1.2rem", fontWeight: "800" }}>Feel<span style={{ color: "#e8845a" }}>Good</span><span style={{ fontSize: "0.6rem", color: "#333", marginLeft: "0.7rem", letterSpacing: "0.2em" }}>PITCH · MAY 11</span></span>
